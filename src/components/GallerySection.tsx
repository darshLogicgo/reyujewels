...
const galleryItems = [
  { id: 1, image: gallery1, title: "Diamond Solitaire Ring", category: "Rings" },
      ...
      <div className="container-luxury">
        ...
        >
          ...
          <p className="text-luxury mt-4">
            Explore our curated collection of handcrafted diamond jewellery, 
            each piece a testament to our artisans' dedication to perfection.
          </p>
        </motion.div>
        ...
        >
          {galleryItems.map((item, index) => (
            <motion.div
              ...
              className="group relative mb-5 overflow-hidden rounded-sm cursor-pointer"
            >
              <img
                src={item.image}
                alt={item.title}
